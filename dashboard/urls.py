...
urlpatterns = [
    ...
    # sign in with Discord — the callback URL goes in the Developer Portal «Redirects»
    path('account/discord/', views.discord_login, name='discord_login'),
    path('account/discord/callback/', views.discord_callback, name='discord_callback'),
    ...
    path('dashboard/settings/discord/', dv.discord_settings, name='dash_discord'),
]
